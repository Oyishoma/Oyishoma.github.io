...
<head>
  <meta charset="utf-8">
  <title>Oyishoma Peter - Personal Portfolio</title>
  <!-- Description-->
  <meta name="description" content="Personal Portfolio">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <!-- icons-->
  <link rel="apple-touch-icon" sizes="180x180" href="img/icons/oyishoma-icon.jpg">
  <link rel="icon" type="image/png" sizes="32x32" href="img/icons/oyishoma32x32.png">
  <link rel="icon" type="image/png" sizes="16x16" href="img/icons/oyishoma16x16.png">
  <!-- Web fonts-->
...
<body class="theme-dark">
  ...
  <div class="preloader">
    <div class="preloader-block">
      <div class="preloader-icon"><span class="loading-dot loading-dot-1"></span></div>
    </div>
  </div>
  ...
  <nav class="navbar-expand-md navbar fixed-top" id="navbar"><a class="navbar-brand" data-scroll="" href="#home-area">
      <!-- Navbar Logo-->
      <img class="img-fluid" src="img/oyishoma-logo.jpg" alt="Logo"></a>
  ...
  <!-- Home-->
  <section class="home-area element-cover-bg" id="home" style="background-image:url(img/home-bg-bw.png)">
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center">
        <div class="col-12 col-lg-8 home-content text-center">
          <h1 class="home-name">Oyishoma <span>Peter</span></h1>
          ...
          <div class="lightbox-content">
            ...
            <div class="info-section single-section">
              <div class="row align-items-center">
                <!-- Picture part-->
                <div class="col-12 col-lg-5 info-img"><img class="img-fluid img-thumbnail" src="img/home-bg.png" alt="About Picture"></div>
                <!-- Content part-->
                <div class="col-12 col-lg-7 info-content">
                  <div class="content-block">
                    <h6 class="content-title">I'm Oyishoma Peter, a visual UX/UI Designer and Web Developer</h6>
                    <div class="content-description">
                      <p>I am a freelancer based in Nigeria and i have been building noteworthy UX/UI designs and websites for years, which comply with the latest design trends. I help convert a vision and an idea into meaningful and useful products. Having a sharp eye for product evolution helps me prioritize tasks, iterate fast and deliver faster.</p>
                    </div>
                    <address class="content-info">
                      <div class="row">
                        ...
                        <div class="col-12 col-md-6 single-info"><span>Email:</span>
                          <p><a href="mailto:Oyishoma@example.com">oyishomapeter@gmail.com</a></p>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-12 col-md-6 single-info"><span>Location:</span>
                          <p>Abuja, Nigeria</p>
                        </div>
                      </div>
                    </address>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><i class="icon service-icon ion-logo-css3"></i>
                    ...
                    <p class="service-description">I develop apps, websites and make visual designs that are trendy, following industry standards and creating stunning visual interfaces that suits my client's needs.</p>
                  </div>
                </div>
                <!-- Single service-->
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><i class="icon service-icon ion-md-images"></i>
                    <h6 class="service-title">Graphic Designs</h6>
                    <p class="service-description">I create graphic illustrations and designs for flyers, posters, biilboards etc. I also create logo designs for whatever purpose suits you. </p>
                  </div>
                </div>
                <!-- Single service-->
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><i class="icon service-icon ion-logo-ionic"></i>
                    ...
                    <p class="service-description">Experience round the clock support and feedbacks.     </p>
                  </div>
                </div>
                <!-- Single service-->
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><i class="icon service-icon ion-logo-wordpress"></i>
                    ...
                    <p class="service-description">Development from scratch and wordpress designs</p>
                  </div>
                </div>
                <!-- Single service-->
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><i class="icon service-icon ion-md-move"></i>
                    ...
                    <p class="service-description">All products are fully responsive to all kinds of devices</p>
                  </div>
                </div>
                <!-- Single service-->
                <div class="col-12 col-md-6 col-lg-4">
                  <div class="single-service"><i class="icon service-icon ion-ios-rocket"></i>
                    ...
                    <p class="service-description">Business brands</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="single-review swiper-slide">
                    <div class="review-header d-flex justify-content-between">
                      <div class="review-client">
                        <div class="media"><img class="img-fluid rounded-circle client-avatar" src="img/oyishoma-logo.jpg" alt="Client">
                          <div class="client-details">
                            <h6 class="client-name">Kingsley Chi</h6><span class="client-role">Client</span>
                          </div>
                        </div>
                      </div><i class="icon ion-md-quote review-icon"></i>
                    </div>
                    <p class="review-content">Oyishoma did an excellent creative job, addressing our request quickly, and also providing his own visual insight, being open to feedback and changes or edits when they arose. He worked with us the entire way. Highly recommended.</p>
                  </div>
                </div>
                <div class="slider-item">
                  <!-- Single review-->
                  <div class="single-review swiper-slide">
                    <div class="review-header d-flex justify-content-between">
                      <div class="review-client">
                        <div class="media"><img class="img-fluid rounded-circle client-avatar" src="img/oyishoma-logo.jpg" alt="Client">
                          <div class="client-details">
                            <h6 class="client-name">Sample Testimonial</h6><span class="client-role">Entrepreneur</span>
                          </div>
                        </div>
                      </div><i class="icon ion-md-quote review-icon"></i>
                    </div>
                    <p class="review-content">Oyishoma is awesome at his job. I will let you do my website projects againa and again. I highly recommend</p>
                  </div>
                </div>
                <div class="slider-item">
                  <!-- Single review-->
                  <div class="single-review swiper-slide">
                    <div class="review-header d-flex justify-content-between">
                      <div class="review-client">
                        <div class="media"><img class="img-fluid rounded-circle client-avatar" src="img/oyishoma-logo.jpg" alt="Client">
                          <div class="client-details">
                            <h6 class="client-name">Maria Wilson</h6><span class="client-role">Client</span>
                          </div>
                        </div>
                      </div><i class="icon ion-md-quote review-icon"></i>
                    </div>
                    <p class="review-content">Oyishoma did an excellent creative job, addressing our request quickly, and also providing her own graphic insight, being open to feedback and changes or edits when they arose. She worked with us the entire way. Highly recommended.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                  <div class="single-plan mb-4 mb-sm-5"><i class="plan-icon icon ion-md-egg"></i>
                    <h3 class="plan-type"> Visual Design</h3>
                    <h2 class="plan-price">$19/month</h2>
                    <ul class="list-unstyled plan-list">
                      <li>UI/UX Designs</li>
                      <li>Logo Designs</li>
                      <li>Flyers/Banners/Posters</li>
                      <li>Source Files</li>
                ...
                <div class="col-lg-4">
                  <div class="single-plan mb-4 mb-sm-5"><i class="plan-icon icon ion-ios-rocket"></i>
                    <h3 class="plan-type">Wordpress designs</h3>
                    <h2 class="plan-price">$29/month</h2>
                    <ul class="list-unstyled plan-list">
                      <li>Ecommerce Sites</li>
                      <li>Portfolios/Personal Sites</li>
                ...
                <div class="col-lg-4">
                  <div class="single-plan mb-4 mb-sm-5"><i class="plan-icon icon ion-logo-ionic"></i>
                    <h3 class="plan-type">Web Development</h3>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6">
                  <div class="col-block education">
                    ...
                    <div class="resume-item"><span class="item-arrow"></span>
                      <h5 class="item-title">Cyber Security Science</h5><span class="item-details">Federal University of Technology, Minna</span>
                      <p class="item-description">In view</p>
                    </div>
                    <div class="resume-item"><span class="item-arrow"></span>
                      <h5 class="item-title">The Complete WebDeveloper Bootcamp</h5><span class="item-details">Udemy</span>
                      <p class="item-description">HTML, CSS, Bootstrap, SASS, JavaScript, Jquery,  React, Node.js</p>
                    </div>
                    <div class="resume-item"><span class="item-arrow"></span>
                      <h5 class="item-title">UI/UX Design Masterclass</h5><span class="item-details">Udemy</span>
                      <p class="item-description">User Interface, User Experience, Design Trends</p>
                    </div>
                  </div>
                </div>
                <!-- Experience part-->
                <div class="col-12 col-md-6">
                  <div class="col-block experience">
                    ...
                    <div class="resume-item"><span class="item-arrow"></span>
                      <h5 class="item-title">Graphic Designer</h5><span class="item-details">Freelance since 2013</span>
                      <p class="item-description">Proficient with CorelDraw Graphic Suite and Adobe Photoshop.</p>
                    </div>
                    <div class="resume-item"><span class="item-arrow"></span>
                      <h5 class="item-title">Web Developer</h5><span class="item-details">Freelance since 2018</span>
                      <p class="item-description">Fullstack Developement, Wordpress WebDesign. </p>
                    </div>
                    <div class="resume-item"><span class="item-arrow"></span>
                      <h5 class="item-title">UI/UX Designer</h5><span class="item-details">Freelance since 2019</span>
                      <p class="item-description">Proficient with Figma, Sketch and Photoshop</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="single-skill" data-percentage="95">
                    <div class="skill-info"><span class="skill-name">UI/UX</span><span class="skill-percentage"></span></div>
                    <div class="progress skill-progress">
                      <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
                  <div class="single-skill" data-percentage="90">
                    <div class="skill-info"><span class="skill-name">Graphic Design</span><span class="skill-percentage"></span></div>
                    <div class="progress skill-progress">
                      <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                  </div>
          ...
          <div class="lightbox-content">
            <div class="row">
              <div class="col-12">
                <div class="section-heading page-heading">
                  ...
                  <p class="section-description">Some of my best work</p>
                  <div class="animated-bar"></div>
                </div>
              </div>
            </div>
            ...
            <div class="portfolio-section single-section">
              <div class="row">
                ...
                <div class="col-12">
                  <ul class="list-inline filter-control" role="group" aria-label="Filter Control">
                    ...
                    <li class="list-inline-item" data-filter=".brand">Web Projects</li>
                    <li class="list-inline-item" data-filter=".design">UI/UX Designs</li>
                    <li class="list-inline-item" data-filter=".photos">Graphic Designs</li>
                  </ul>
                </div>
              </div>
              <!-- Thumbnail list-->
              <div class="portfolio-grid row">
                <!-- Single item-->
                <div class="single-item col-6 col-lg-4 design"><a class="portfolio-item" href="img/temporal_image.jpg" data-lightbox>
                    <div class="portfolio-wrapper"><img class="img-fluid" alt="Item" src="img/temporal_image.jpg">
                ...
                <!-- Single item-->
                <div class="single-item col-6 col-lg-4 photos"><a class="portfolio-item" href="img/temporal_image.jpg" data-lightbox>
                    <div class="portfolio-wrapper"><img class="img-fluid" alt="Item" src="img/temporal_image.jpg">
                      <div class="item-content">
                        <h6 class="content-title">coming soon</h6><span class="content-more">More Info</span>
                      </div>
                ...
                <!-- Single item-->
                <div class="single-item col-6 col-lg-4 brand"><a class="portfolio-item" href="img/temporal_image.jpg" data-lightbox>
                    <div class="portfolio-wrapper"><img class="img-fluid" alt="Item" src="img/temporal_image.jpg">
                      <div class="item-content">
                        <h6 class="content-title">coming soon</h6><span class="content-more">More Info</span>
                      </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="section-heading page-heading">
                  ...
                  <h2 class="section-title">Oyishoma's Blog</h2>
                  <div class="animated-bar"></div>
                </div>
              </div>
            </div>
            ...
            <div class="contact-section single-section">
              <div class="row">
                ...
                <div class="col-12 col-lg-7">
                  <form class="" id=" " action="insert.php" method="post" enctype="multipart/form-data">
                    <h4 class="content-title">Send me a message</h4>
                    <div class="row">
                       <div class="col-12 col-md-12"> <br> 
                          ...
                          <div class="col-12 col-md-12"> <br> 
                              <textarea name="message" id="" rows="4" class="form-control" required></textarea> <br>
                          </div>
                          <input type="submit" name="submit" class="btn btn-success" style="background-color:#009e66" value="Submit">
                        </div>
                  </form>
                </div>
                <!-- Contact info-->
                      ...
                      <li>
                        <div class="media align-items-center"><span class="info-icon"><i class="icon ion-logo-ionic"></i></span>
                          <div class="media-body info-details">
                            <h6 class="info-type">Name</h6><span class="info-value">Oyishoma Peter</span>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="media align-items-center"><span class="info-icon"><i class="icon ion-md-send"></i></span>
                          <div class="media-body info-details">
                            <h6 class="info-type">Email Me</h6><span class="info-value"><a href="mailto:Oyishoma@example.com">oyishomapeter@gmail.com</a></span>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="media align-items-center"><span class="info-icon"><i class="icon ion-md-map"></i></span>
                          <div class="media-body info-details">
                            <h6 class="info-type">Location</h6><span class="info-value">Nigeria</span>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="media align-items-center"><span class="info-icon"><i class="icon ion-md-call"></i></span>
                          <div class="media-body info-details">
                            <h6 class="info-type">Phone</h6><span class="info-value"><a href="tel:+2348075695830">(+234)8075695830 </a></span>
                          </div>
                        </div>
                      </li>
                    </ul>
